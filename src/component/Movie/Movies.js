...
const Movies = () =>{
    ...
    const {movies,loading,error,movieCount,resultPerPage, filteredMoviesCount  } = useSelector(state => state.movies);
    ...
    },[dispatch,keyword,currentPage,price,genre,ratings,error]);
