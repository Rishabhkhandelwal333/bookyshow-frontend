...
const MyOrders = () => {
    ...
    const columns =[
        ...
        {field:"status",headerName : "Status",minWidth:150,flex:0.5,cellClassName:(params)=>{
            return params.getValue(params.id,"status") === "Booked" ? "greenColor":"redColor";
        }},
        {field:"movies_qty",headerName:"Movies",type:"number",minWidth:150,flex:0.3},
        {field:"amount",headerName:"Amount",type:"number",minWidth:270,flex:0.5},
        {field:"actions",headerName:"ViewTicket",type:"number",minWidth:100,flex:0.3,sortable:false,
        renderCell:(params)=>{
            return(
